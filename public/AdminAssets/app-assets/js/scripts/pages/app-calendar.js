...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function fetchEvents(info, successCallback) {
    ...
    $.ajax(
      {
        url: 'https://courseszone-eg.com/AdminPanel/getGroupsSchedule',
        type: 'GET',
        ...
        //   return [result.events.filter(event => calendars.includes(event.extendedProps.calendar))];
            // return [result.filter(event => calendars.includes(event.extendedProps.calendar.toLowerCase()))];
            selectedEvents = result.filter(function (event) {
