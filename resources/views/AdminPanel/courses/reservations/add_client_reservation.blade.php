...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {{Form::open(['url'=>route('admin.add_client_reservation.submit'), 'id'=>'createReservationForm', 'class'=>'row gy-1 pt-75','files'=>'true'])}}
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            {{Form::text('cellphone',$cellphone,['id'=>'cellphone', 'class'=>'form-control','required'])}}
                        </div>
