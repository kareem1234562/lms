        ...
        <div class="card">
            <div class="card-header d-flex justify-content-center align-items-center">
                <h4 class="card-title text-center">
                    ...
                    <br>
                    <small class="text-muted">{{trans('common.month')}}:
                        <?php
            ...
            <div class="card-body">
                <div class="d-flex justify-content-center mb-3 text-center">
                    ...
                    <div class="me-2">
                        ...
                        <h3 class="fw-bolder">
                            <sup class="font-medium-1 fw-bold">{{trans('common.L.E')}}</sup>
                            <span class="text-success">{{round(revenuesTotals($branch, $month, $year)['year_revenues'])}}</span>
                        </h3>
                    </div>
                    <div>
                        <p class="card-text mb-50">{{trans('common.net')}}</p>
                        <h3 class="fw-bolder">
                            <sup class="font-medium-1 fw-bold">{{trans('common.L.E')}}</sup>
                            <span class="text-primary">{{round(revenuesTotals($branch, $month, $year)['year_revenues'] - expensesTotals($branch, $month, $year)['yearTotal'])}}</span>
                        </h3>
                    </div>
                </div>
                        ...
                        @foreach(allMonthsArray() as $singleMonth)
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php $thisMonthRevenue = round(revenuesTotals($branch, [date('m',strtotime($singleMonth))], date('Y',strtotime($singleMonth)))['month_revenues']); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    <div class="col-12 col-md-4">
                            ...
                            {{Form::select('month[]',monthArray(session()->get('Lang')),isset($_GET['month']) ? $_GET['month'] : date('m'),['id'=>'month', 'class'=>'form-select','multiple'])}}
                        </div>
                        <div class="col-12 col-md-4">
