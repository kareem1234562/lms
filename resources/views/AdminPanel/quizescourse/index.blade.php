                            ...
                            @forelse($quizes as $quize)
                                <tr id="row_{{$quize->id}}">
                                    ...
                                    <td class="text-center">
                                        <img src="{{asset('uploads/quizescourse/icons/'.$quize->icon)}}" alt="no" width="100" height="100" style="border-radius: 100%;" >
                                    </td>

                                    <td class="text-center">

                                    <a href="{{route('newcourse.quizes.question.show',$quize->id)}}" class="btn btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="{{trans('Question')}}">
                                        ...
                                        <a href="javascript:;" data-bs-target="#editchapter{{$quize->id}}" data-bs-toggle="modal" class="btn btn-icon btn-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="{{trans('common.edit')}}">
                                            ...
                                            <?php $delete = route('newcourse.quizes.delete',['id'=>$quize->id]); ?>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{Form::open(['url'=>route('newcourse.quizes.update',$quize->id), 'id'=>'editchapterForm'.$quize->id, 'class'=>'row gy-1 pt-75','files'=>'true'])}}
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div>
                        <img src="{{asset('uploads/quizescourse/icons/'.$quize->icon)}}" alt="no" width="100" style="border-radius: 100%;">
                        </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{Form::open(['url'=>route('newcourse.quizes.store',$course_id), 'id'=>'createcourseForm', 'class'=>'row gy-1 pt-75','files'=>'true'])}}
