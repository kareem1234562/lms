...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav {{themeModeClasses()['navbar']}} navbar-shadow container-xxl">
        <div class="navbar-container d-flex content">
            <div class="bookmark-wrapper d-flex align-items-center">
                ...
                {{-- @include('AdminPanel.layouts.topbar.new_reservation') --}}
            </div>
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                ...
                <div class="modal fade text-md-start" id="addstudent" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-5 pt-50">
                                <div class="text-center mb-2">
                                    <h1 class="mb-1">البحث عن بيانات الطالب</h1>
                                </div>
                                {{Form::open(['url'=>route('admin.new_reservation'), 'id'=>'addstudentForm', 'class'=>'row gy-1 pt-75'])}}
                                    <div class="col-12 col-md-12">
                                        <label class="form-label" for="cellphone">رقم الهاتف</label>
                                        {{Form::text('cellphone','',['id'=>'cellphone', 'class'=>'form-control','required'])}}
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".lessonFile").fileinput({
                showUpload: false,
                dropZoneEnabled: true,
                maxFileCount: 1,
                allowedFileExtensions: ["xlsx", "xls", "pdf", "docx", "doc"],
                inputGroupClass: "input-group-lg"
            });
        });
