...
@section('content')
    ...
    @endif
        ...
        <td class="text-center">
            ...
            <?php $delete = route('newcourse.quizes.question.delete', ['id' => $question->id]); ?>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body pb-5 px-sm-5 pt-50">
            ...
            {{Form::open(['url'=>route('newcourse.quizes.question.update', $question->id), 'id'=>'updateQuestionForm'.$question->id, 'class'=>'row gy-1 pt-75','files'=>'true'])}}
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    ...
                    {{Form::open(['url'=>route('newcourse.quizes.question.store',$quiz_id), 'id'=>'createcourseForm', 'class'=>'row gy-1 pt-75','files'=>'true'])}}
