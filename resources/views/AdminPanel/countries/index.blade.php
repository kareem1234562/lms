                    ...
                    <table class="table table-bordered mb-2">
                        ...
                        <tbody>
                            ...
                            <tr id="row_{{$country->id}}">
                                ...
                                <td class="text-center">
                                    <a href="{{route('admin.univerisities',$country->id)}}" class="btn btn-icon btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="{{trans('learning.univerisities')}}">
