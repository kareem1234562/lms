...
class QuestionLessonController extends Controller
{
    /**
    ...
    public function store(Request $request,$id)
    {
        ...
        $store = QuestionLesson::create($data);
    ...
    {
        $data=$request->except('_token');
        $question=QuestionLesson::find($id);
    ...
    {
        $question_course = QuestionLesson::find($id);
